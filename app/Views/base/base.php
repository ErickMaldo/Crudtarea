...
<head>
	...
	<body class="hold-transition sidebar-mini layout-fixed">
		...
		<script type="text/javascript" src="<?= base_url() ?>/plugins/inputmask/jquery.inputmask.js"></script>

		<?= $this->renderSection("section-script") ?>
	</body>
	</html>
